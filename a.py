...
async def bot(runner_args: RunnerArguments, testing: Optional[bool] = False):
    ...
    # ✅ Tata SmartFlo-style / Twilio media stream compatible serializer
    # ✅ No TWILIO_AUTH_TOKEN, no REST API, no env TWILIO_ACCOUNT_SID required
    serializer = TwilioFrameSerializer(
        ...
        params=TwilioFrameSerializer.InputParams(
            ...
            auto_hang_up=False,  # ✅ Important for Tata SmartFlo-style flows
        ),
    )
